    ...
    <SafeAreaView edges={TAB_SCREEN_SAFE_EDGES} style={styles.safe}>
      <ScrollView style={styles.formScroll} contentContainerStyle={[styles.scrollContent, { paddingBottom: getTabScreenBottomPadding(insets.bottom, 34) }]}>
        ...
        <View style={styles.biddingHand} accessibilityLabel="أوراقك الحالية للمزايدة">
          ...
          <CurvedCardHand cards={state.players[0].hand} curveStrength={game.settings.cardFanCurve} cardBackPattern={game.settings.cardBackPattern} cardFaceTheme={game.settings.cardFaceTheme} animationSpeed={game.settings.animationSpeed} accessibilityLabel="أوراقك الحالية مرتبة ضمن قوس متساوٍ للمزايدة" />
        </View>
...
const styles = StyleSheet.create({
  ...
  featureGrid: { flexDirection: arabicRow(), gap: 8, marginTop: 34 },
  ...
  playerStrip: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 8, marginTop: 16, justifyContent: "center" },
  ...
  biddingHandHeader: { flexDirection: arabicRow(), alignItems: "center", justifyContent: "space-between", paddingHorizontal: 14, marginBottom: 9 },
  ...
  strengthHeader: { flexDirection: arabicRow(), alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 12 },
  strengthTitleRow: { flexDirection: arabicRow(), alignItems: "center", alignSelf: "flex-start", gap: 6 },
  ...
  strengthGrid: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 8 },
  ...
  strengthCardTop: { flexDirection: arabicRow(), alignItems: "center", gap: 5 },
  ...
  strengthBars: { flexDirection: arabicRow(), gap: 3, marginTop: 9 },
  ...
  infoSheetHeader: { flexDirection: arabicRow(), gap: 14, justifyContent: "space-between", alignItems: "flex-start" },
  ...
  rankPoints: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 6, marginTop: 8 },
  ...
  infoLevels: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 6, alignItems: "center", borderTopWidth: 1, borderTopColor: "#E7E0CE", paddingTop: 12, marginTop: 12 },
  ...
  bidGrid: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 9, marginTop: 18, justifyContent: "center" },
  ...
  suitGrid: { flexDirection: arabicRow(), flexWrap: "wrap", gap: 12, marginTop: 34, justifyContent: "center" },
  ...
  finalScore: { flexDirection: arabicRow(), alignItems: "center", backgroundColor: "rgba(255,248,231,0.1)", borderRadius: 24, padding: 20, marginVertical: 30, minWidth: 270 },
  ...
  roundShortcutRow: { flexDirection: arabicRow(), gap: 10, width: "100%", maxWidth: 360, marginTop: 14 },
  roundShortcut: { flex: 1, minHeight: 70, borderRadius: 17, padding: 11, flexDirection: arabicRow(), alignItems: "center", justifyContent: "flex-start", gap: 8, borderWidth: 1 },
  ...
  tableActionRow: { flexDirection: arabicRow(), alignItems: "center", gap: 5 },
  headerActionRow: { flexDirection: arabicRow(), alignItems: "center", gap: 8 },
  ...
  matchAction: { flexDirection: arabicRow(), alignItems: "center", gap: 12, minHeight: 72, borderRadius: 17, paddingHorizontal: 14, paddingVertical: 10, borderWidth: 1, marginTop: 10 },
  ...
  confirmationButtons: { flexDirection: arabicRow(), gap: 10, marginTop: 6 },
  ...
  logSheetHeader: { flexDirection: arabicRow(), alignItems: "flex-start", justifyContent: "space-between", marginBottom: 14 },
  ...
  logBidRow: { flexDirection: arabicRow(), alignItems: "center", justifyContent: "space-between", minHeight: 42, paddingHorizontal: 12, borderRadius: 12, backgroundColor: "#EDF5EF", marginBottom: 6 },
