...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 22, paddingTop: 12, paddingBottom: 16, flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "flex-start", borderBottomWidth: 1, borderColor: "rgba(255,248,231,0.15)" },
  ...
  networkReady: { minHeight: 46, paddingHorizontal: 14, borderRadius: 14, backgroundColor: "rgba(88,214,141,0.14)", flexDirection: "row-reverse", alignItems: "center", gap: 9, borderWidth: 1, borderColor: "rgba(88,214,141,0.24)" },
  ...
  action: { minHeight: 70, borderRadius: 18, paddingHorizontal: 18, paddingVertical: 12, backgroundColor: "#FFF8E7", flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between" },
  ...
  flowProgress: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "flex-end", gap: 7, minHeight: 28 },
  ...
  hostStatus: { paddingHorizontal: 14, paddingVertical: 11, borderRadius: 14, backgroundColor: "rgba(88,214,141,0.14)", flexDirection: "row-reverse", alignItems: "center", gap: 9, borderWidth: 1, borderColor: "rgba(88,214,141,0.26)" }, hostStatusDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: "#58D68D" }, hostStatusText: { color: "#D9EEE4", flex: 1, textAlign: "right", fontSize: 12, fontWeight: "800", writingDirection: "rtl" },
