...
يستخدم التطبيق مؤثرات بطاقات قصيرة من Pixabay بموجب رخصة Pixabay Content License الظاهرة في صفحات المصدر، إضافة إلى الملفات التي يرفقها المستخدم صراحةً للاستخدام داخل اللعبة.

> يعتمد مؤثر لعب الورقة الملف الذي اختاره المستخدم، وهو مقطع قصير يعبر عن أخذ بطاقة لعب بدلاً من خلط الأوراق أو رميها بقوة.
